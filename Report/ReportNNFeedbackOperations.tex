...
\newcommand{\fullname}{Sebastian Vendt}
\newcommand{\email}{Sebastian.Vendt@uni-ulm.de}
\newcommand{\titel}{Der Titel der Arbeit, meist länger als eine Zeile}
\newcommand{\jahr}{2019}
\newcommand{\matnr}{752219}
\newcommand{\gutachterA}{}
\newcommand{\gutachterB}{}
\newcommand{\betreuer}{Christian Jarvers}
...
{\footnotesize Projektseminar Neuroinformatik an der Universität Ulm}\\[3em]
...
\input{chapters/vorstellungPaper}
\input{chapters/verifikation}
